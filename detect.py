...
if __name__ == "__main__":
    weights=ROOT / 'yolov5s.pt' # Module Location


    # Datasource
    #source = 'rtsp://192.168.31.108'  #Live camara
    #source = 'rtsp://192.168.31.108'
    source = 'rtsp://192.168.137.148'
    #source =   'data' # 0 # image or video Directory ROOT / 'data'
    #source = '0' # 0 representing local camara

    project=ROOT / 'runs'  # Saving directory
    name='exp'  # Filename

    imgsz=416  # 图片大小
    conf_thres=0.25  # 置信度
    iou_thres=0.45  # MNS抑制阈值
    max_det=10000  # 每张图像的最大检测次数
